...
from adsws.auth.schema import bootstrap_get_request_schema, bootstrap_get_response_schema, BootstrapGetRequestSchema
...
class Bootstrap(Resource):
    def get(self):
        ...
        if current_user.is_bootstrap_user and (params.scope or params.client_name or params.redirect_uri):
            abort(
                401, message="Sorry, you cant change scope/name/redirect_uri when creating temporary OAuth application"
            )
